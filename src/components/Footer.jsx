        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-4 place-items-center max-w-screen-lg mx-auto">
          <div>
            <h5 className="font-medium mt-4">
              <span className="text-blue-600">Stay</span>cation.
            </h5>
          ...
          <div>
            <h5 className="font-poppins text-[18px] font-normal leading-[27px] text-left text-[#152C5B] mt-4">
              For Beginners
            </h5>
            <menu className="text-[#B0B0B0] font-poppins text-[16px] font-light leading-[24px] text-left">
              ...
              <Link to="/booking" className="block mt-1">
                Book a Room
              </Link>
              <Link to="/payment" className="block mt-1">
                Payments
              </Link>
            </menu>
          </div>
          ...
          <div>
            <h5 className="font-poppins text-[15px] font-normal leading-[25px] text-left text-[#152C5B] mt-4">
              Getting Touch
            </h5>
            <menu className="text-[#B0B0B0] font-poppins text-[16px] font-light leading-[24px] text-left">
              <Link to="#" className="block mt-2">
                support@stayctation.id
              </Link>
              <Link to="#" className="block mt-1">
                021 - 2208 - 1996
              </Link>
