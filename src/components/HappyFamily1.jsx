  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full">
      <div className="relative w-full h-[541px] border border-solid border-[#E5E5E5] rounded-tr-[15px] rounded-br-[15px] p-[1px]">
        <img src="/images/happy1.svg" className="w-full h-full rounded-tr-[15px] rounded-br-[15px]" alt="Happy Family" />
      </div>
      <div className="relative w-full h-auto p-4">
        <h5 className="text-[24px] font-normal leading-[36px] text-[#152C5B]">Happy Family</h5>
        ...
        <button className="w-[210px] h-[50px] bg-[#3252DF] rounded-[4px] shadow-lg mt-14">
          <span className="text-[18px] font-medium leading-[30.6px] text-white">Read Our Stories</span>
        </button>
      </div>
    </div>
  );
